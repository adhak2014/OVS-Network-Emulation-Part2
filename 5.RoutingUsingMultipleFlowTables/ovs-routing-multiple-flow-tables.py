...
def myNetwork():
    ...
    s1.setMAC('00:00:00:00:00:03', intf='s1-eth1')
    info('MAC(s1-eth1) = ', s1.MAC(intf = 's1-eth1'), '\n')
    s2.setMAC('00:00:00:00:00:04', intf='s2-eth1')
    info('MAC(s2-eth1) = ', s2.MAC(intf = 's2-eth1'), '\n')
    s1.setMAC('00:00:00:00:00:05', intf='s1-eth2')
    info('MAC(s1-eth2) = ', s1.MAC(intf = 's1-eth2'), '\n')
    s2.setMAC('00:00:00:00:00:06', intf='s2-eth2')
